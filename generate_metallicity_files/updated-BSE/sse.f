...
*
      ...
      character*50 charmass,charz,chartphysf
      character*50 charneta,charbwind,charhewind,charsigma
      character*50 charifflag,charwdflag,charbhflag
      character*50 charnsflag,charmxns,charidum
      character*50 charpsflag,charkmech,charecflag
      character*50 charpts1,charpts2,charpts3
...
*     READ(22,*)pts1,pts2,pts3
      ...
      CALL GETARG(1, charmass)
      CALL GETARG(2, charz)
      CALL GETARG(3, chartphysf)
      READ(charmass, *) mass
      READ(charz, *) z
      READ(chartphysf, *) tphysf
      
      CALL GETARG(4, charneta)
      CALL GETARG(5, charbwind)
      CALL GETARG(6, charhewind)
      CALL GETARG(7, charsigma)
      READ(charneta, *) neta
      READ(charbwind, *) bwind
      READ(charhewind, *) hewind
      READ(charsigma, *) sigma
      
      CALL GETARG(8, charifflag)
      CALL GETARG(9, charwdflag)
      CALL GETARG(10, charbhflag)
      CALL GETARG(11, charnsflag)
      CALL GETARG(12, charmxns)
      CALL GETARG(13, charidum)
      READ(charifflag, *) ifflag
      READ(charwdflag, *) wdflag
      READ(charbhflag, *) bhflag
      READ(charnsflag, *) nsflag
      READ(charmxns, *) mxns
      READ(charidum, *) idum
      
      CALL GETARG(14, charpsflag)
      CALL GETARG(15, charkmech)
      CALL GETARG(16, charecflag)
      READ(charpsflag, *) psflag
      READ(charkmech, *) kmech
      READ(charecflag, *) ecflag

      CALL GETARG(17, charpts1)
      CALL GETARG(18, charpts2)
      CALL GETARG(19, charpts3)
      READ(charpts1, *) pts1
      READ(charpts2, *) pts2
      READ(charpts3, *) pts3
